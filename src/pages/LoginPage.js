                ...
                <div className="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
                    <div className="flex-1">
                        <div className="text-center">
                            <h2 className="text-4xl font-bold text-center  text-white">QUYÊN GÓP TỪ THIỆN</h2>
                            {msg === "fieldEmpty"
                        ...
                        <div className="mt-8">
                            <form>
                                <div>
                                    <label htmlFor="phone" className="block mb-2 text-sm  text-gray-200">Tài khoản (Số điện thoại):</label>
                                    <input value={phoneNumber}
                                        onChange={(e) => setPhoneNumeber(e.target.value)} autoComplete="current-password" type="text" name="phone" id="phone" placeholder="012345679" className="block w-full px-4 py-2 mt-2 t border rounded-md placeholder-gray-600 bg-gray-900 text-gray-300 border-gray-700  focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>
                                ...
                                <div className="mt-6">
                                    ...
                                    <input value={password}
                                        onChange={(e) => setPassword(e.target.value)} autoComplete="current-password" type="password" name="password" id="password" placeholder="Mật khẩu của bạn" className="block w-full px-4 py-2 mt-2  border  rounded-md placeholder-gray-600 bg-gray-900 text-gray-300 border-gray-700  focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>
